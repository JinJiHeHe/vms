 ...
 */
public class DQueryTerminalParamResponse {

	private int replaySerialNumber;// 应答流水号
	private int packageParamsNumber;// 包参数个数
//	private BoTerminalParameterInfo this;// 参数项(实体类)
	...
	public String toInstrResponseText(){
		String instrresponsetext  = "终端心跳间隔:" + this.getHeartBeatTime() + "\r\n" + "TCP消息应答超时时间:" + this.getTcpResponseTime() + "\r\n"
				...
				+ "\r\n"
				+ "主服务器无线通信拨号用户名:"
				+ this.getMainwirelessUser()
				+ "\r\n"
				+ "主服务器无线通信拨号密码:"
				+ this.getMainwirelesspassword()
				+ "\r\n"
				+ "主服务器地址，IP或域名:"
				+ this.getMainIP()
				+ "\r\n"
				...
				+ "\r\n"
				+ "备用服务器无线通信拨号用户名:"
				+ this.getBackupwirelessUser()
				+ "\r\n"
				+ "备用服务器无线通信拨号密码:"
				+ this.getBackupwirelesspassword()
				+ "\r\n"
				+ "备用服务器地址，IP或域名:"
				+ this.getBackupIP()
				+ "\r\n"
				...
				+ "\r\n"
				+ "监控平台电话号码:"
				+ this.getPlatphoneNum()
				+ "\r\n"
				+ "复位电话号码:"
				+ this.getResetPhoneNum()
				+ "\r\n"
				+ //
				"恢复出厂设置电话号码:"
				+ this.getRestorefactoryPhoneNum()
				+ "\r\n"
				+ //
				"监控平台SMS号码:"
				+ this.getPlatSMSnum()
				...
				+ "\r\n"
				+ //
				"当月最长通话时间:" + this.getPerMonthMaxphonetime() + "\r\n" + "监听电话号码:" + this.getMonitorPhoneNum() + "\r\n"
				+ "监管平台特权短信号码:" + this.getMonitorplatMessageNum() + "\r\n" + "报警屏蔽子:" + this.getAlarmshield() + "\r\n"
