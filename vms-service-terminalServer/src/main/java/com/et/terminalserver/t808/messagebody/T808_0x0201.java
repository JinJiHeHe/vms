 ...
 * @Project: CNPC_VMS
 * @Title: T808_0x0201
 * @Description: 位置信息查询应答类
 * @author: lijz
 * @date: 2014年5月13日 上午9:47:23
 * @company: Beijing Huayou Information andCommunication Technology Co.,Ltd
 * @Copyright: Copyright (c) 2014
 * @version V2.0
 */
public class T808_0x0201 extends T808_MessageBody {
	...
	public String toString() {
		return "T808_0x0201 [platformSerialNumber=" + platformSerialNumber
				+ ", alarmSign=" + alarmSign + ", status=" + status
