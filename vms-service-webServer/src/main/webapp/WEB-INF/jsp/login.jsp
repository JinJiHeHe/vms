...
<head>
    <title>登入界面</title>
    <script src="http://api.map.baidu.com/api?v=2.0&ak=3ifW06URXxsYvbA9btjujrG8OoIb0fPQ"
    ...
    <style type="text/css">
        ...
        * {
        ...
        body {
            font-family: "微软雅黑";
            font-size: 14px;
            background: url("${pageContext.request.contextPath}/image/1.jpg") fixed center center;
        }
        ...
        .u_user {
            width: 25px;
            height: 25px;
            background: url(${pageContext.request.contextPath}/image/login_ico.png);
        ...
        .u_psw {
            width: 25px;
            height: 25px;
            background-image: url(${pageContext.request.contextPath}/image/login_ico.png);
...
<div class="login_box">
    <form id="loginform" method="post" action="../user/login.do">
        <div class="input_outer">
            ...
            <input id="username" class="text" onfocus=" if(this.value=='输入用户名') this.value=''"
                   onblur="if(this.value=='') this.value='输入用户名'" value="输入用户名" style="color: #FFFFFF !important"
